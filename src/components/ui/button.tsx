  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // ElSawa7 brand variants
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-accent font-semibold",
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-glow text-base font-semibold",
        ...
        "accent-outline": "border-2 border-accent text-accent bg-transparent hover:bg-accent hover:text-accent-foreground font-semibold",
      },
      size: {
